...
public class StringsLesson {
    public static void main(String[] args) {
        ...
        int count = 1;
        double rating = 5.5;
        String formattedString = MessageFormat.format("“овар: {0}. Ќа складе: {1}шт. –ейтинг: {2}.",
                item, count, rating);
        System.out.println(formattedString);

        MessageFormat messageFormat = new MessageFormat("“овар: {0}. Ќа складе: {1, choice, 0#товар отсутствует|0<мало|5<много}. –ейтинг: {2}.", Locale.UK);
